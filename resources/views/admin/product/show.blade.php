...
<section class="py-8 bg-white md:py-16 antialiased h-screen ">
    <div class="max-w-screen-xl px-4 mx-auto 2xl:px-0">
      <div class="lg:grid lg:grid-cols-2 lg:gap-8 xl:gap-16">
        <div class="shrink-0 max-w-md lg:max-w-lg mx-auto">
          <img class="w-full dark:hidden" src="/uploads/products/{{$product->image}}" alt="" />
          <img class="w-full hidden dark:block" src="/uploads/products/{{$product->image}}" alt="" />
        </div>
        ...
        <div class="mt-6 sm:mt-8 lg:mt-0">
          ...
          <a
            ...
            class="text-base  text-gray-400 sm:text-large underline "
          >
