...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        {{-- <title>{{ config('app.name', 'MediCare Assist') }}</title> --}}
...
<footer
  class="flex flex-col items-center text-center text-white " style="background-color: #385399">
  <div class="container px-6 pt-6">
    ...
    <div class="mb-6">
      <p>
        Stay informed and empowered on your health journey – sign up for our newsletter to receive exclusive updates, health tips, and personalized insights from our medical assistance service.
      </p>
    </div>
    ...
    <div class="grid md:grid-cols-2 lg:grid-cols-3">
      <div class="mb-6">
        <h5 class="mb-2.5 font-bold uppercase" style="color: black" >Quick Links</h5>
      ...
      <div class="mb-6">
        <h5 class="mb-2.5 font-bold uppercase"  style="color: black" >Popular Links</h5>
      ...
      <div class="mb-6">
        <h5 class="mb-2.5 font-bold uppercase" style="color: black">Contact Us</h5>
  ...
  <div
    ...
    <!-- Back to Top -->
    <a href="#" class="btn btn-lg btn-primary btn-lg-square back-to-top" style="position:fixed; display:none; right:30px; bottom: 0; border-radius: 50% 50% 0 0; z-index:99;" ><i class="bi bi-arrow-up"></i></a>
